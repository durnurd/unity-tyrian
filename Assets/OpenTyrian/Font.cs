...
public static class FontC
{
     ...
     *        the text.)
     */
    public static void draw_font_hv_shadow(Surface surface, int x, int y, string text, Font font, FontAlignment alignment, byte hue, sbyte value, bool black, int shadow_dist)
    {
     ...
     */
    public static void draw_font_hv_full_shadow(Surface surface, int x, int y, string text, Font font, FontAlignment alignment, byte hue, sbyte value, bool black, int shadow_dist)
    {
     ...
     * @param value value component of text color
     */
    public static void draw_font_hv(Surface surface, int x, int y, string text, Font fontE, FontAlignment alignment, byte hue, sbyte value)
    {
        int textIdx = 0;
        ushort font = (ushort)fontE;

        switch (alignment)
        {
            case FontAlignment.left_aligned:
                break;
            case FontAlignment.centered:
                x -= JE_textWidth(text, font) / 2;
                break;
            case FontAlignment.right_aligned:
        ...
        for (; textIdx < text.Length && text[textIdx] != '\0'; ++textIdx)
        {
            int sprite_id = font_ascii[text[textIdx]];
            ...
            switch (text[textIdx])
            {
                ...
                default:
                    if (sprite_id != -1 && sprite(font, sprite_id) != null)
                    {
     ...
     * @param value value component of text color
     */
    public static void draw_font_hv_blend(Surface surface, int x, int y, string text, Font fontE, FontAlignment alignment, byte hue, sbyte value)
    {
        int textIdx = 0;
        ushort font = (ushort)fontE;
     ...
     */
    public static void draw_font_dark(Surface surface, int x, int y, string text, Font fontE, FontAlignment alignment, bool black)
    {
        int textIdx = 0;
        ushort font = (ushort)fontE;
